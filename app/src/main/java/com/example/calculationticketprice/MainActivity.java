...
public class MainActivity extends AppCompatActivity {
    ...
    // создание объекта сущности билетов для пенсионеров (стоимость белета, количество билетов, скидка)
    RailwayTicket railwayTicketPension = new RailwayTicketPension(70, 5, 30);
    ...
    private TextView railwayTicketPensionOut; // поле вывода общей стоимости билетов для пенсионеров
    ...
    protected void onCreate(Bundle savedInstanceState) { // создание жизненного цикла активности
        ...
        railwayTicketOut = findViewById(R.id.railwayTicketOut2); // вывод информации стоимости всех взрослых билетов
        railwayTicketChildOut = findViewById(R.id.railwayTicketChildOut2); // вывод информации стоимости всех детских билетов
        railwayTicketPensionOut = findViewById(R.id.railwayTicketPensionOut2);// вывод информации стоимости всех билетов для пенсионеров
        railwayTicketTotalOut = findViewById(R.id.railwayTicketTotalOut2); // вывод информации стоимости всех билетов
        ...
        railwayTicketPensionOut.setText(Float.toString(railwayTicketPension.ticketPriceAll()) + " монет");
        // 4) заполнение четвертого поля стоимостью всех билетов
        railwayTicketTotalOut.setText(Float.toString(railwayTicket.ticketPriceAll() + railwayTicketChild.ticketPriceAll() + railwayTicketPension.ticketPriceAll()) + " монет");
